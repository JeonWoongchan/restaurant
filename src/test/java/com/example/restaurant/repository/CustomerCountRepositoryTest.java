...
// Customer("김규식","rbtlr1234","kksos28@naver.com","010-4260-9481",100);
//
//
...
// CustomerCount foundCustomerCount =
// customerCountRepository.findById(customerCount.getCount_id()).orElse(null);
