                        ...
                        <div className="payment-main">
                            <div className="payment-product">
                                ...
                                <div className="detail">
                                    ...
                                    <p>전화번호 : {guestReservConfirm.phone ? guestReservConfirm.phone.substring(0, 3) + '-' + guestReservConfirm.phone.substring(3, 7) + '-' + guestReservConfirm.phone.substring(7) : null}</p>
                                </div>
